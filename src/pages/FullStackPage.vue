...
const navHeight = computed(() => document.getElementById('navbar').offsetHeight)
...
.gradient-1 {
    background: rgb(239, 248, 180) none repeat scroll 0% 0% / auto padding-box border-box;
    width: 700px;
    height: 700px;
...
.gradient-2 {
    background: rgb(130, 141, 135) none repeat scroll 0% 0% / auto padding-box border-box;
    width: 600px;
    height: 600px;
    animation-duration: 11s;
    opacity: 0.22;
...
.gradient-3 {
    background: rgb(185, 159, 118) none repeat scroll 0% 0% / auto padding-box border-box;
    width: 500px;
    height: 500px;
    animation-duration: 11s;
    opacity: 0.22;
